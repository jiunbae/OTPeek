//! otp-sync: pluggable encrypted-blob sync — SyncBackend trait, merge engine,
//! WebDAV backend. See docs/ARCHITECTURE.md §6 (frozen contract).

use otp_core::{OtpAccount, OtpFolder};
...
pub mod webdav {
    ...
    impl WebDavBackend {
        ...
        /// https://host/remote.php/dav/files/me/otp-vault.otpvault
